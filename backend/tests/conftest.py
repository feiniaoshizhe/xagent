...
from xagent.services.redis.dependency import get_redis_pool
from aio_pika import Channel
from aio_pika.abc import AbstractExchange, AbstractQueue
from aio_pika.pool import Pool
from xagent.services.rabbit.dependencies import \
    get_rmq_channel_pool
from xagent.services.rabbit.lifespan import (init_rabbit,
                                                                    shutdown_rabbit)

from xagent.settings import settings
from xagent.web.application import get_app
from sqlalchemy.ext.asyncio import (AsyncConnection, AsyncEngine, AsyncSession,
                                    async_sessionmaker, create_async_engine)
from xagent.db.dependencies import get_db_session
from xagent.db.utils import create_database, drop_database
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine, None]:
    ...
    from xagent.db.models import load_all_models
